...
public class lesson_17_49 {
    ...
    public static boolean isWeekend(LocalDateTime dateTime) {
        ...
        if (day == SATURDAY)
            return true;
        else if ( day == FRIDAY && dateTime.getHour()>=WEEKEND_START_FRIDAY_CUT_OFF_HOUR)
        {
            return true;
        }
        else if (day == SUNDAY && dateTime.getHour()<WEEKEND_END_SUNDAY_CUT_OFF_HOUR){
            return true;
        }
        else return false;
    }
